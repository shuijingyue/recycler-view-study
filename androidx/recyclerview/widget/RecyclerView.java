...
public class RecyclerView extends ViewGroup implements ScrollingView,
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            if (holder == null) {
                ...
                if (holder == null) { // fallback to pool
                    ...
                    Log.i("wxp", "tryGetViewHolderForPositionByDeadline pool " + position);
                    if (holder != null) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            for (int i = 0; i < scrapCount; i++) {
                ...
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position
                    ...
                    holder.addFlags(ViewHolder.FLAG_RETURNED_FROM_SCRAP);
                    Log.i("wxp", "getScrapOrHiddenOrCachedHolderForPosition mAttachedScrap " + position);
                    return holder;
                }
            }
            ...
            for (int i = 0; i < cacheSize; i++) {
                ...
                if (!holder.isInvalid() && holder.getLayoutPosition() == position
                    ...
                    Log.i("wxp", "getScrapOrHiddenOrCachedHolderForPosition mCachedViews " + position);
                    return holder;
                }
            }
            return null;
    ...
    public abstract static class LayoutManager {
        ...
        public void detachAndScrapAttachedViews(@NonNull Recycler recycler) {
            final int childCount = getChildCount();
            Log.i("wxp", "detachAndScrapAttachedViews " + childCount);
            for (int i = childCount - 1; i >= 0; i--) {
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            Log.i("wxp", "scrapOrRecycleView " + index);
            final ViewHolder viewHolder = getChildViewHolderInt(view);
            if (viewHolder.shouldIgnore()) {
                if (DEBUG) {
